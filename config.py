...
# CHANNEL_USERNAME — kanalning @username'i (bot shu kanalda ADMIN bo'lishi shart,
# aks holda obunani tekshira olmaydi).
CHANNEL_USERNAME = os.getenv("CHANNEL_USERNAME", "@soat_space")
CHANNEL_URL = os.getenv("CHANNEL_URL", "https://t.me/soat_space")
